defmodule Otp23SlowdownWeb.UserAuthTest do
  use Otp23SlowdownWeb.ConnCase, async: true

  alias Otp23Slowdown.Accounts
  alias Otp23SlowdownWeb.UserAuth
  import Otp23Slowdown.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Otp23SlowdownWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Otp23SlowdownWeb.Endpoint.subscribe(live_socket_id)
