defmodule Otp23Slowdown.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Otp23Slowdown.Repo)
  ...
  """
  def valid_password?(%Otp23Slowdown.Accounts.User{hashed_password: hashed_password}, password)
